...
/**
 * This class provides a wrapper for network errors when making requests to Autonomous API
 */
export class InducedAiError extends Error {
  /**
   * The response body
   */
